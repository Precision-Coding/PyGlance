...
class Camera():
    def __init__(self):
        ...
        t_left = -(np.dot(self.direction_vector, self.position_vector)-self.k)/np.dot(self.direction_vector, self.left_bounding_box)
        self.left_bounding_coordinate = self.position_vector + t_left*self.left_bounding_box
        self.right_bounding_coordinate = self.position_vector + t_left*self.right_bounding_box
        t_bottom = -(np.dot(self.direction_vector, self.position_vector)-self.k)/np.dot(self.direction_vector, self.bottom_bounding_box)
        self.bottom_bounding_coordinate = self.position_vector + t_bottom*self.bottom_bounding_box
        self.top_bounding_coordinate = self.position_vector + t_bottom*self.top_bounding_box
